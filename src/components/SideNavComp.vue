<template>
    <nav class="navside-container">
        ...
        <router-link :to="items[2].route" :class="{'navside-item': true, 'active': items[2].isActive }">
        ...
        <router-link :to="items[4].route" :class="{'navside-item': true, 'active': items[4].isActive }">
