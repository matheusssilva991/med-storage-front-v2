...
<template>
  ...
  <ButtonComp type="btn-outline-primary" text="Button" icon="fa-solid fa-user-secret"/>
  <ButtonComp type="btn-outline-secondary" text="Button" icon="fa-solid fa-user-secret"/>
