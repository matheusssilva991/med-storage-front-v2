<template>
    <form @submit.prevent="onSubmit">
        <ModalComp :open="open" title="Editar banco de imagens" @close="close">
            <template #content>
...
onMounted(async () => {
    ...
    imageQuality.value = database.imageQuality.join(', ');
    examType.value = { value: database.examType.name, _id: database.examType._id };
    imageType.value = { value: database.imageType.name, _id: database.imageType._id };
});
